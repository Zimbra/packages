...
%changelog
* Tue Feb 08 2022 Zimbra Packaging Services <packaging-devel@zimbra.com> - VERSION-1zimbra8.7b4ZAPPEND
- Updated postfix (removed libmariadb.so.3 from postfix package)
