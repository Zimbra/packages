...
%changelog
* Mon Mar 04 2024 Zimbra new updated modified Packaging Services <packaging-devel@zimbra.com> - VERSION-1zimbra8.7b2ZAPPEND
...
Requires:       zimbra-libsodium-libs >= 1.0.19-1zimbra10.0b1ZAPPEND, zimbra-base
AutoReqProv:        no
