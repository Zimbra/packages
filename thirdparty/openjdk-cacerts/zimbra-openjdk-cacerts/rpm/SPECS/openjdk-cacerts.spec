...
License:            MPL-2
Requires:           zimbra-base, zimbra-openjdk >= 17.0.19-1zimbra8.8b1ZAPPEND
...
%changelog
* Wed Jul 15 2026 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.13-1zimbra8.7b1ZAPPEND
- ZCS-19953, Updated zimbra-openjdk-cacerts CA root store
* Mon Sep 15 2025 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.12-1zimbra8.7b1ZAPPEND
- ZCS-17668, Updated zimbra-openjdk-cacerts CA root store
...
if [ "$1" -ge "2" ]; then
  if [ -x /opt/zimbra/bin/zmcertmgr ]; then
    ...
    for dir in /opt/zimbra/.saveconfig/zimbra-openjdk-cacerts-1.0.{5..12}*; do
        if [ -d "$dir" ]; then
