...
BuildRequires:      zimbra-perl-io-sessiondata, zimbra-perl-io-socket-ssl >= 2.068-1zimbra8.7b2ZAPPEND
BuildRequires:      zimbra-perl-lwp-protocol-https >= 6.06-1zimbra8.7b3ZAPPEND, zimbra-perl-libwww >= 6.13-1zimbra8.7b3ZAPPEND
BuildRequires:      zimbra-perl-task-weaken, zimbra-perl-uri, zimbra-perl-xml-parser >= 2.44-1zimbra8.7b3ZAPPEND
...
Requires:           zimbra-perl-io-sessiondata, zimbra-perl-io-socket-ssl >= 2.068-1zimbra8.7b2ZAPPEND
Requires:           zimbra-perl-lwp-protocol-https >= 6.06-1zimbra8.7b3ZAPPEND, zimbra-perl-libwww >= 6.13-1zimbra8.7b3ZAPPEND
Requires:           zimbra-perl-task-weaken, zimbra-perl-uri, zimbra-perl-xml-parser >= 2.44-1zimbra8.7b3ZAPPEND
