...
BuildRequires:      zimbra-perl-base, zimbra-perl-dbi
Requires:           zimbra-perl-base, zimbra-perl-dbi
AutoReqProv:        no
URL:                https://metacpan.org/release/MODNAME

%description
DBD::SQLite is a Perl DBI driver for SQLite, that includes the entire thing in the
distribution. So in order to get a fast transaction capable RDBMS working for
your perl project you simply have to install this module, and nothing else.
