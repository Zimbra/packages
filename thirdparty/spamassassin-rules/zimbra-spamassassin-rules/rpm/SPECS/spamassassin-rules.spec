...
License:            Apache-2.0
Requires:           zimbra-mta-base, zimbra-perl-mail-spamassassin >= 4.0.1-1zimbra8.8b5ZAPPEND
...
%changelog
* Tue Oct 01 2024 Zimbra Packaging Services <packaging-devel@zimbra.com> - VERSION-1zimbra8.8b8ZAPPEND
