...
Requires:           zimbra-aspell-ru >= 0.99f7.1-1zimbra8.7b2ZAPPEND, zimbra-aspell-sv >= 0.51.0-1zimbra8.7b2ZAPPEND, zimbra-httpd >= 2.4.38-1zimbra8.7b1ZAPPEND
Requires:           zimbra-php >= 7.3.1-1zimbra8.7b4ZAPPEND, zimbra-aspell-zimbra >= 1.0.0-1zimbra8.7b2ZAPPEND
