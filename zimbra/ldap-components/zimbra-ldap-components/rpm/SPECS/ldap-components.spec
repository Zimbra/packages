...
Requires:           zimbra-core-components >= 2.0.26-1zimbra8.8b1ZAPPEND
...
%changelog
* Wed Nov 29 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.26
- ZBUG-3696, Updated core-components for openjdk, openjdk-cacerts
* Mon Jul 17 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.25
- ZBUG-2931, Updated core-requirements, os-requirements
* Fri Jul 07 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.24
- ZBUG-3355, Updated core-components, OpenSSL License and other 3rd party open source licenses
* Tue Jun 13 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.23
- ZBUG-3355, upgraded OpenSSL to 3.0.9 and Updated core-components to 2.0.23
* Fri Feb 10 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.22
- Fix ZBUG-3278, upgraded OpenSSL to 1.1.1t and Updated core-components to 2.0.22
* Tue Feb 07 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.21
- Upgraded Date-Manip to 6.90, Updated core-components to 2.0.21
* Thu Jan 19 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.20
- Upgraded Compress::Raw::Zlib to 2.103, Updated core-components to 2.0.20
* Mon Sep 12 2022 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.19
