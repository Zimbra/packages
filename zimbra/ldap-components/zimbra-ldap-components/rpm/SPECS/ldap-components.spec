...
License:            GPL-2
Requires:           zimbra-ldap-base, zimbra-lmdb >= 2.5.13-1zimbra8.8b1ZAPPEND
Requires:           zimbra-openldap-server >= 2.5.13-1zimbra8.8b1ZAPPEND
Requires:           zimbra-openssl >= 1.1.1q-1zimbra8.7b4ZAPPEND, zimbra-openssl-libs >= 1.1.1q-1zimbra8.7b4ZAPPEND
Requires:           zimbra-core-components >= 3.0.16-1zimbra8.8b1ZAPPEND
...
%changelog
* Tue Dec 20 2022 Zimbra Packaging Services <packaging-devel@zimbra.com> - 2.0.10
