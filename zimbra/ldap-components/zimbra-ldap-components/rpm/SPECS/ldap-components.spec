...
Requires:           zimbra-openssl >= 1.1.1n-1zimbra8.7b4ZAPPEND, zimbra-openssl-libs >= 1.1.1n-1zimbra8.7b4ZAPPEND
Requires:           zimbra-core-components >= 2.0.16-1zimbra8.8b1ZAPPEND
