...
Requires:           zimbra-opendkim, zimbra-perl-mail-spamassassin >= 3.4.4-1zimbra8.8b1ZAPPEND, zimbra-postfix
Requires:           zimbra-spamassassin-rules >= 1.0.0-1zimbra8.8b1ZAPPEND
