...
Requires:           zimbra-opendkim >= 2.10.3-1zimbra8.7b3ZAPPEND, zimbra-perl-mail-spamassassin >= 3.4.4-1zimbra8.8b2ZAPPEND
...
%changelog
* Thu Sep 10 2020 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.8
