...
Requires:           zimbra-cluebringer, zimbra-mariadb >= 11.4.2-1zimbra10.0b1ZAPPEND
...
%changelog
* Fri Jun 14 2024 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.25
- Updated postfix for mariadb-11.4.2
