...
Requires:           zimbra-opendkim >= 2.10.3-1zimbra8.7b6ZAPPEND, zimbra-perl-mail-spamassassin >= 3.4.6-1zimbra8.8b3ZAPPEND
...
%changelog
* Tue Mar 07 2023 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.20
- Updated opendkim, postfix
