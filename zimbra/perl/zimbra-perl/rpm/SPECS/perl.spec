...
Requires:       zimbra-perl-compress-raw-zlib >= 2.093-1zimbra8.7b1ZAPPEND, zimbra-perl-config-inifiles >= 2.86-1zimbra8.7b2ZAPPEND
...
Requires:       zimbra-perl-data-uuid, zimbra-perl-date-calc >= 6.4-1zimbra8.7b2ZAPPEND, zimbra-perl-date-manip, zimbra-perl-dbd-mysql >= 4.050-1zimbra8.7b4ZAPPEND
...
Requires:       zimbra-perl-io-socket-ip, zimbra-perl-io-socket-ssl >= 2.068-1zimbra8.7b3ZAPPEND, zimbra-perl-io-stringy, zimbra-perl-ip-country
Requires:       zimbra-perl-json-pp
Requires:       zimbra-perl-libwww >= 6.13-1zimbra8.7b4ZAPPEND, zimbra-perl-list-moreutils >= 0.428-1zimbra8.7b1ZAPPEND, zimbra-perl-lwp-mediatypes
...
Requires:       zimbra-perl-net-http >= 6.09-1zimbra8.7b4ZAPPEND, zimbra-perl-net-ldap, zimbra-perl-net-ldapapi, zimbra-perl-net-libidn
...
Requires:       zimbra-perl-xml-namespacesupport, zimbra-perl-xml-parser >= 2.44-1zimbra8.7b4ZAPPEND, zimbra-perl-xml-parser-lite, zimbra-perl-xml-sax
Requires:       zimbra-perl-xml-sax-base, zimbra-perl-xml-sax-expat >= 0.51-1zimbra8.7b4ZAPPEND, zimbra-perl-xml-simple >= 2.25-1zimbra8.7b3ZAPPEND
