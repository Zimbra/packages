...
Requires:       zimbra-perl-data-uuid, zimbra-perl-date-calc >= 6.4-1zimbra8.7b2ZAPPEND, zimbra-perl-date-manip
Requires:       zimbra-perl-dbd-mysql >= 4.050-1zimbra8.7b3ZAPPEND
...
Requires:       zimbra-perl-http-daemon >= 6.01-1zimbra8.7b2ZAPPEND, zimbra-perl-http-date, zimbra-perl-http-message >= 6.11-1zimbra8.7b2ZAPPEND, zimbra-perl-http-negotiate >= 6.01-1zimbra8.7b2ZAPPEND, zimbra-perl-innotop >= 1.9.1-1zimbra8.7b3ZAPPEND
...
Requires:       zimbra-perl-libwww >= 6.13-1zimbra8.7b3ZAPPEND, zimbra-perl-list-moreutils >= 0.428-1zimbra8.7b1ZAPPEND, zimbra-perl-lwp-mediatypes
