...
Requires:       zimbra-perl-bit-vector >= 7.4-1zimbra8.7b2ZAPPEND, zimbra-perl-cache-fastmmap
Requires:       zimbra-perl-canary-stability
...
Requires:       zimbra-perl-compress-raw-zlib >= 2.093-1zimbra8.7b1ZAPPEND
Requires:       zimbra-perl-config-inifiles >= 2.86-1zimbra8.7b2ZAPPEND, zimbra-perl-convert-asn1
Requires:       zimbra-perl-convert-binhex, zimbra-perl-convert-tnef, zimbra-perl-convert-uulib
Requires:       zimbra-perl-crypt-openssl-random >= 0.11-1zimbra8.7b3ZAPPEND
Requires:       zimbra-perl-crypt-openssl-rsa >= 0.31-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-crypt-saltedhash
Requires:       zimbra-perl-data-uuid, zimbra-perl-date-calc >= 6.4-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-date-manip
...
Requires:       zimbra-perl-file-tail, zimbra-perl-geography-countries, zimbra-perl-html-parser
Requires:       zimbra-perl-http-cookies >= 6.01-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-http-daemon >= 6.01-1zimbra8.7b2ZAPPEND, zimbra-perl-http-date
Requires:       zimbra-perl-http-message >= 6.11-1zimbra8.7b2ZAPPEND
...
Requires:       zimbra-perl-io-html, zimbra-perl-io-sessiondata, zimbra-perl-io-socket-inet6
Requires:       zimbra-perl-io-socket-ip, zimbra-perl-io-socket-ssl >= 2.068-1zimbra8.7b3ZAPPEND
Requires:       zimbra-perl-io-stringy, zimbra-perl-ip-country
Requires:       zimbra-perl-json-pp
Requires:       zimbra-perl-libwww >= 6.13-1zimbra8.7b4ZAPPEND
Requires:       zimbra-perl-list-moreutils >= 0.428-1zimbra8.7b1ZAPPEND, zimbra-perl-lwp-mediatypes
Requires:       zimbra-perl-lwp-protocol-https >= 6.06-1zimbra8.7b4ZAPPEND
Requires:       zimbra-perl-mail-dkim >= 0.40-1zimbra8.7b3ZAPPEND, zimbra-perl-mail-spf
Requires:       zimbra-perl-mailtools, zimbra-perl-math-bigint
Requires:       zimbra-perl-mime-lite
Requires:       zimbra-perl-mime-tools, zimbra-perl-mime-types, zimbra-perl-mozilla-ca
Requires:       zimbra-perl-netaddr-ip
Requires:       zimbra-perl-net-cidr, zimbra-perl-net-cidr-lite, zimbra-perl-net-dns
Requires:       zimbra-perl-net-dns-resolver-programmable
Requires:       zimbra-perl-net-http >= 6.09-1zimbra8.7b4ZAPPEND, zimbra-perl-net-ldap, zimbra-perl-net-ldapapi
Requires:       zimbra-perl-net-libidn
Requires:       zimbra-perl-net-server >= 2.009-1zimbra8.7b1ZAPPEND
Requires:       zimbra-perl-net-ssleay >= 1.88-1zimbra8.7b2ZAPPEND, zimbra-perl-parent
Requires:       zimbra-perl-proc-processtable
Requires:       zimbra-perl-soap-lite >= 1.19-1zimbra8.7b4ZAPPEND, zimbra-perl-socket
Requires:       zimbra-perl-socket-linux, zimbra-perl-swatchdog >= 3.2.4-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-task-weaken, zimbra-perl-term-readkey, zimbra-perl-timedate
Requires:       zimbra-perl-unix-getrusage, zimbra-perl-unix-syslog, zimbra-perl-uri, zimbra-perl-www-robotrules
Requires:       zimbra-perl-xml-namespacesupport, zimbra-perl-xml-parser >= 2.44-1zimbra8.7b4ZAPPEND
Requires:       zimbra-perl-xml-parser-lite, zimbra-perl-xml-sax
Requires:       zimbra-perl-xml-sax-base, zimbra-perl-xml-sax-expat >= 0.51-1zimbra8.7b4ZAPPEND
Requires:       zimbra-perl-xml-simple >= 2.25-1zimbra8.7b3ZAPPEND
...
%changelog
* Sun Dec 06 2020 Zimbra Packaging Services <packaging-devel@zimbra.com> - 1.0.6
