...
Requires:       zimbra-perl-crypt-openssl-random >= 0.11-1zimbra8.7b2ZAPPEND, zimbra-perl-crypt-openssl-rsa >= 0.31-1zimbra8.7b1ZAPPEND
Requires:       zimbra-perl-crypt-saltedhash
Requires:       zimbra-perl-data-uuid, zimbra-perl-date-calc, zimbra-perl-date-manip, zimbra-perl-dbd-mysql >= 4.050-1zimbra8.7b3ZAPPEND
...
Requires:       zimbra-perl-innotop >= 1.9.1-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-io-compress, zimbra-perl-io-html, zimbra-perl-io-sessiondata, zimbra-perl-io-socket-inet6
Requires:       zimbra-perl-io-socket-ip, zimbra-perl-io-socket-ssl >= 2.068-1zimbra8.7b1ZAPPEND, zimbra-perl-io-stringy, zimbra-perl-ip-country
Requires:       zimbra-perl-json-pp
Requires:       zimbra-perl-libwww >= 6.13-1zimbra8.7b2ZAPPEND, zimbra-perl-list-moreutils, zimbra-perl-lwp-mediatypes
Requires:       zimbra-perl-lwp-protocol-https >= 6.06-1zimbra8.7b2ZAPPEND
Requires:       zimbra-perl-mail-dkim >= 0.40-1zimbra8.7b2ZAPPEND, zimbra-perl-mail-spf, zimbra-perl-mailtools, zimbra-perl-math-bigint
...
Requires:       zimbra-perl-net-http >= 6.09-1zimbra8.7b2ZAPPEND, zimbra-perl-net-ldap, zimbra-perl-net-ldapapi, zimbra-perl-net-libidn
Requires:       zimbra-perl-net-server
Requires:       zimbra-perl-net-ssleay >= 1.88-1zimbra8.7b1ZAPPEND, zimbra-perl-parent, zimbra-perl-proc-processtable
Requires:       zimbra-perl-soap-lite >= 1.19-1zimbra8.7b2ZAPPEND, zimbra-perl-socket
...
Requires:       zimbra-perl-xml-sax-base, zimbra-perl-xml-sax-expat >= 0.51-1zimbra8.7b2ZAPPEND, zimbra-perl-xml-simple >= 2.25-1zimbra8.7b1ZAPPEND
