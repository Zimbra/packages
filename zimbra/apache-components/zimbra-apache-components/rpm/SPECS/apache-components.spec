...
License:            GPL-2
Requires:           zimbra-apache-base, zimbra-httpd >= 2.4.38-1zimbra8.7b2ZAPPEND, zimbra-php >= 7.3.1-1zimbra8.7b3ZAPPEND
...
%changelog
* Thu Sep 10 2020 Zimbra Packaging Services <packaging-devel@zimbra.com> - 2.0.1
